...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "relative h-32 w-full cursor-pointer overflow-hidden rounded-xl border p-4 transition-all duration-300 shadow-sm hover:bg-primary/[0.03] hover:dark:bg-neutral-800/10",
        // light styles
