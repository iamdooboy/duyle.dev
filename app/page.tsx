    ...
    <>
      <section className="h-full">
        ...
        <p className="mb-4 text-primary">
          I'm a creative web developer passionate about UI design and teaching
          others, dedicated to building engaging experiences with great
          attention to detail. I devote most of my time learning and refining my
          skills.
        </p>
