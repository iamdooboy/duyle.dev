...
export function AnimatedCircularProgressBar({
  ...
  const gaugePrimaryColor = getGaugeColor(currentPercent)
  const gaugeSecondaryColor = "#6b7280" // Light gray for the background
          ...
          style={
            {
              ...
              transitionProperty: "stroke-dasharray,transform,stroke",
              transform:
