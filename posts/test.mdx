...
The useStorage hook is one of the many selector hooks provided by Liveblocks. It is used to
extract data from Liveblocks Storage. Here are the key breakdown: 
